...
I = imread('madu_polos.jpg');
figure, imshow(I);
title('Citra Madu polos RGB');
...
figure, imshow(R);
title('Citra Madu polos Channel R');

figure, imshow(G);
title('Citra Madu polos Channel G');

figure, imshow(B);
title('Citra Madu polos Channel B');
...
title('Citra Madu polos Grayscale');
...
title('Histogram Citra Madu polos Grayscale Cara 1');

% Kode program membuat histogram (Cara 2)
figure, histogram(citraGray);
title('Histogram Citra Madu polos Grayscale Cara 2');

% Kode program membuat histogram (Cara 3)
figure, histogram(citraGray, 256);
title('Histogram Citra Madu polos Grayscale Cara 3');

% Pengaturan Kecerahan
citraCerah = citraGray + 50;
figure, imshow(citraCerah);
title('Citra Madu polos Madu polos penambahan intensitas');
figure, histogram(citraCerah);
title('Histogram Citra Madu polos penambahan intensitas');

citraGelap = citraGray - 50;
figure, imshow(citraGelap);
title('Citra Madu polos Madu polos penambahan intensitas');
figure, histogram(citraGelap);
title('Histogram Citra Madu polos pengurangan intensitas');

% Meregangkan kontras
regangKontras = citraGray * 1.5;
figure, imshow(regangKontras);
title('Citra Madu polos peregangan kontras');
figure, histogram(regangKontras);
title('Histogram Citra Madu polos peregangan kontras');

% Membalik citra
balikCitra = 255 - citraGray;
figure, imshow(balikCitra);
title('Citra Madu polos pembalikan citra');
figure, histogram(balikCitra);
title('Histogram Citra Madu polos pembalikan citra');
...
figure, imshow(Hasil);
title('Citra Madu polos grayscale pemotongan aras keabuan');
figure, histogram(Hasil);
title('Histogram Citra Madu polos grayscale pemotongan aras keabuan');
...
title('Citra Madu polos grayscale hasil histeq')
figure, histogram(Hasilekual);
title('Histogram Citra Madu polos grayscale hasil histeq');